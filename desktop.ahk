; i-3 style desktop switching with autohotkey
; Windows + number to switch to desktop 
; Shift + Windows + number to move current window to desktop
; Shift + Windows + 0 to show current window on all desktops 
;
; Script requires DLL from https://github.com/Ciantic/VirtualDesktopAccessor to be present next to autohotkey exe.
; Most functionality copied from https://github.com/yalibian/i3-windows
